...
void GpsTransform::wgs2gcj(double wgsLat, double wgsLng, double * gcjLat, double * gcjLng)
{
...
void GpsTransform::gcj2wgs(double gcjLat, double gcjLng, double * wgsLat, double * wgsLng)
{
...
void GpsTransform::gcj2wgs_exact(double gcjLat, double gcjLng, double * wgsLat, double * wgsLng)
{
...
inline double GpsTransform::distance(double latA, double lngA, double latB, double lngB)
{
...
inline int GpsTransform::outOfChina(double lat, double lng) {
...
inline void GpsTransform::transform(double x, double y, double * lat, double * lng) {
	double xy = x * y;
...
inline void GpsTransform::delta(double lat, double lng, double * dLat, double * dLng) {
